        ...
        format_date: function() {
            return function(u) {
                ...
                fn = {
                    ...
                    m: function() {
                        return _pad(jsdate.getMonth() + 1);
                    },
                    d: function() {
                        return _pad(jsdate.getDate());
                    },
                    h: function() {
                        return _pad(jsdate.getHours());
                    },
                    i: function() {
                        return _pad(jsdate.getMinutes());
                    },
                    s: function() {
                        return _pad(jsdate.getSeconds());
                    }
                };
                u = isNaN(parseInt(u, 10)) ? 0 : parseInt(u, 10);
                jsdate = new Date(u * 1e3);
                return "y-m-d h:i:s".replace(/\\?(.?)/gi, function(t, s) {
                    return fn[t] ? fn[t]() : s;
                });
            };
        },
